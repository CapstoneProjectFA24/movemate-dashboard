  ...
  return (
    <section style={{
      ...
      <div className="flex space-x-4 border-b border-gray-300 mb-6 pt-8">
        <button
          className={`py-2 ${activeTab === 'services1' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600'}`}
          onClick={() => setActiveTab('services1')}
        >
          Dịch vụ bốc xếp
        </button>
        <button
          className={`py-2 ${activeTab === 'services2' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600'}`}
      ...
      {activeTab === 'services1' && (
        <div data-aos="fade-left">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-6">Dịch Vụ Bốc Xếp</h2>

          <div data-aos="fade-left" className="mt-4">
            <h3 className="font-semibold">Bốc Xếp (Bởi Tài Xế)</h3>
            <p>
              👉 Phí cơ bản: <strong>120.000đ/người/xe</strong> cho tối đa 3 tầng. Nếu công trình có từ 4 đến 5 tầng,
              giá sẽ tăng thêm 20% cho mỗi tầng. Đối với những công trình trên 5 tầng, mức tăng là 25%. <br />
              🛠️ Bao gồm: Hỗ trợ bốc xếp hàng hóa bởi tài xế (không bao gồm nhân viên bốc xếp chuyên nghiệp).
            </p>
          </div>
          ...
          <div data-aos="fade-left" className="mt-4">
            ...
            <p>
              👉 Phí cơ bản: <strong>400.000đ/người</strong> cho tối đa 3 tầng. Tăng giá theo tầng: từ 4 đến 5 tầng,
              giá sẽ tăng thêm 20% cho mỗi tầng. Với những công trình trên 5 tầng, mức tăng là 25%. <br />
              🛠️ Bao gồm: Nhân viên bốc xếp chuyên nghiệp đảm bảo hàng hóa được xử lý an toàn và nhanh chóng.
            </p>
          </div>

          <div data-aos="fade-left" className="mt-4">
            <h3 className="font-semibold">Bốc Xếp Sử Dụng Thang Máy Nhỏ Hoặc Không Có Thang Máy</h3>
            <p>👉 Phí: <strong>100.000đ/tầng</strong>.</p>
          </div>

          <div data-aos="fade-left" className="mt-4">
            <h3 className="font-semibold">Bốc Xếp Tại Địa Điểm Khó Tiếp Cận 🚧</h3>
            <p>
              👉 Phí thêm: <strong>20.000đ cho mỗi 10m</strong>, tối đa 50 đơn vị. <br />
              🛠️ Bao gồm: Phí áp dụng cho những địa điểm mà xe tải không thể đến gần, cần di chuyển hàng hóa qua quãng đường dài.
            </p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'services2' && (
        <div data-aos="fade-left">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-6">Dịch Vụ Tháo Lắp và Đóng Gói</h2>
          <h3 className="font-semibold">Tháo Lắp, Đóng Gói Máy Lạnh</h3>
          <p>👉 Phí: <strong>300.000đ/bộ</strong>. <br /> 🛠️ Bao gồm: Dịch vụ tháo lắp và đóng gói điều hòa...</p>

          <h3 className="font-semibold">Tháo Lắp, Đóng Gói Các Đồ Vật Khác</h3>
          <p>👉 Phí: <strong>150.000đ/bộ</strong> cho đồ vật nhỏ (≤5kg), <strong>300.000đ/bộ</strong> cho đồ vật lớn...</p>
        </div>
      )}
    </section>
  );
