          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border p-4 bg-gray-50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <p>
                  <strong>Tên:</strong> {userData?.data?.name}
                </p>
                <p>
                  <strong>Số điện thoại:</strong> {userData?.data?.phone}
                </p>
                <p>
                  <strong>Giới tính:</strong>{" "}
                  {userData?.data?.gender === "Male" ? "Nam" : "Nữ"}
                </p>
                <p>
                  <strong>Email:</strong> {userData?.data?.email}
                </p>
                <p>
                  <strong>Ngày sinh:</strong> {userData?.data?.dob}
                </p>
                <p>
                  <strong>Vai trò:</strong>{" "}
                  {userData?.data?.roleName.toUpperCase() === "DRIVER"
                    ? "Nhân viên lái xe"
                    : "Không xác định"}
                </p>
              </div>
            ...
            {userData?.data?.userInfos &&
              userData.data.userInfos.length > 0 && (
